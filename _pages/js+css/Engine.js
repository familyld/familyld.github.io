...
Enjine.GameCanvas.prototype = {
    Initialize: function(a, b, c) { //参数a是字符串canvas，b是画布的长度，c是画布的高度
...
Enjine.Resources = {
    ...
    ResetSound: function(a) {
        for (var b = 0; b < this.Sounds[a].length; b++) this.Sounds[a].currentTime = 0,
            this.StopLoop(a, b);
        return this
    },
...
Enjine.GameStateContext = function(a) { //参数a是Mario.LoadingState()
    this.State = null;
    if (a != null) this.State = a,
        this.State.Enter() // 此处调用了LoadingState.Enter()
};
...
Enjine.DrawableManager.prototype = {
    ...
    Update: function(a) {
        for (var b = 0,
                b = 0; b < this.Objects.length; b++) this.Objects[b].Update && this.Objects[b].Update(a)
    },
    Draw: function(a, b) {
        if (this.Unsorted) this.Unsorted = !1,
            this.Objects.sort(function(a, b) {
                return a.ZOrder - b.ZOrder
            });
        for (var c = 0,
                c = 0; c < this.Objects.length; c++) this.Objects[c].Draw && this.Objects[c].Draw(a, b)
    }
};
...
Enjine.Application.prototype = {
    ...
    Initialize: function(a, b, c) { //参数a是Mario.LoadingState()，b是画布的长度，c是画布的高度
        this.canvas = new Enjine.GameCanvas;
        this.timer = new Enjine.GameTimer;
        Enjine.KeyboardInput.Initialize();
        this.canvas.Initialize("canvas", b, c); // 初始化Enjine.GameCanvas
