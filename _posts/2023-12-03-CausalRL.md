...
Feel free to give us a star ⭐ if you found this helpful. We also greatly appreciate everyone [contributing](https://github.com/familyld/Awesome-Causal-RL/blob/main/CONTRIBUTING.md) together! 😊
...
Okay, the basics end here. Causal science is an extensive field with many concepts, terminologies, and techniques worth exploring. However, to keep this post concise, we won't delve further into it. 🕊️ Interested readers can refer to related books[^3][^5], our survey paper and blogs for more information:

[Zhihong Deng：【干货】《统计因果推理入门》读书笔记](https://zhuanlan.zhihu.com/p/380711267)
...
- [Zhihong Deng：一篇顶刊论文背后的故事 | TPAMI (2023) 用于离线强化学习的伪相关削减术](https://zhuanlan.zhihu.com/p/665683090) (Chinese version)
...
- 【Tutorial】[Towards Causal Reinforcement Learning](http://auai.org/uai2019/tutorials.php#tutorial3) [[Video](https://www.youtube.com/watch?v=-cfXn3vopyw)] (UAI 2019)
- 【Tutorial】[Towards Causal Reinforcement Learning](https://crl.causalai.net/) [[Video](https://www.youtube.com/watch?v=QRTgLWfFBMM)] (ICML 2020)
...
Prof. Yoshua Bengio has been actively promoting the development of the emerging field of causal representation learning in recent years. His collaborative paper with Prof. Bernhard Schölkopf[^14] also includes discussions related to Causal RL.
...
References
======
[^1]: “Causal Parrots: Large Language Models May Talk Causality But Are Not Causal.”  https://arxiv.org/abs/2308.13067
[^2]: "The Book of Why" - Introduction.  http://bayes.cs.ucla.edu/WHY/
[^3]: “Causality. ” http://bayes.cs.ucla.edu/BOOK-2K/
[^4]: "Causal Inference Using Potential Outcomes."  https://www.jstor.org/stable/27590541
[^5]: “Causal Inference in Statistics: A Primer.” http://bayes.cs.ucla.edu/PRIMER/
...
[^15]: “Generative Agents: Interactive Simulacra of Human Behavior.”  https://dl.acm.org/doi/abs/10.1145/3586183.3606763
[^16]:  “Introducing GPTs.” https://openai.com/blog/introducing-gpts
